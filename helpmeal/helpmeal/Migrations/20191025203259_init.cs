    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ShoppingDaysOfWeekId = table.Column<long>(nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    UserId = table.Column<string>(nullable: true),
                    DaysOfShopping = table.Column<byte>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShoppingDaysOfWeeks", x => x.ShoppingDaysOfWeekId);
                    table.ForeignKey(
                        name: "FK_ShoppingDaysOfWeeks_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RecipeIngredientId = table.Column<long>(nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    RecipeId = table.Column<long>(nullable: false),
                    IngredientId = table.Column<long>(nullable: false),
                    Amount = table.Column<int>(nullable: false)
...
<<<<<<< HEAD:helpmeal/helpmeal/Migrations/20191025213308_initial.cs
                values: new object[] { "fda69db5-12b3-4107-baac-b94ea1853b21", "6c2da111-bdf2-42f1-9a99-d1e92546213a", "User", "USER" });
=======
                values: new object[] { "4dc54848-89ed-411c-9d41-8d70bda8ab0e", "4a0b7ca0-fe2f-4d85-84a8-55d0c564bf82", "User", "USER" });
>>>>>>> cdf824a95907fba4a85e73bad1fe6ea2f068aebc:helpmeal/helpmeal/Migrations/20191025203259_init.cs
